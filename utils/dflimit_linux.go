...
func IncreaseFDLimit() {
	...
	if rlm.Cur < 5000 {
		fmt.Println("[OPTION] File descriptor soft limit is too small: ", rlm.Cur, "! The problem may be solved by executing the following command before launching BTCAgent: ulimit -Sn 65535")
	}
}
